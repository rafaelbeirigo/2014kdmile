...
\newcommand{\grifar}[1]{\colorbox{MidnightBlue}{\textcolor{Black}{\textbf{#1}}}}
...
\begin{algorithmic}[1]                 % enter the algorithmic environment
    ...
    \STATE $Q_B(s_t,\ a_t) \xleftarrow{\alpha} r^e_{t} + r^i_t +
    ...
    \STATE \grifar{$r^e_{t+1} \leftarrow$ recompensa extrínsica
      recebida na transição $s_t,\ a_t \rightarrow \sd$}
