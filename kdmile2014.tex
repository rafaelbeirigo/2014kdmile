...
maior eficiência de aprendizado por parte do agente que utiliza
\mi\, pois este diminui o tempo necessário para a solução do problema
com uma maior rapidez em relação ao agente que utiliza somente
