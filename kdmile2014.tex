...
subproblemas componentes do problema original, permitindo o
aprendizado simultâneo da solução para o problema original e seus
subproblemas. Quando o problema original possui uma estrutura
\emph{hierárquica}, é comum o agente ter de resolver mais de uma vez
o mesmo subproblema em momentos diferentes. Nesses casos, a
...
o mesmo subproblema mais de uma vez, permitindo o reuso do
...
responsável por identificar subproblemas e criar políticas parciais
...
associar subproblemas a variações significativas de atributos
...
relevantes para a identificação dos subproblemas.
...
finitos de estados e ações respectivamente, $R:S\rightarrow\Re$
representa a recompensa \emph{extrínseca} $r^e$ recebida ao alcançar
um estado $s \in S$ e $P:S\times A\times S \rightarrow [0,1]$ a
probabilidade de alcançar um estado a partir de outro através da
...
ser obtida através do Q-Learning \cite{watkins1989learning}, uma
...
$\epsilon$ e gulosas com probabilidade $1 - \epsilon$, configurando o
compromisso
